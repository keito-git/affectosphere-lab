...
- **優先テーマ(いずれか)**:
  ① AI × 感情(感情認識・生成・倫理・ Well-being・人とのインタラクション)
  ② そのままビジネス応用できる AI(HR・マーケ・コンプラ・リーガル・自動車・医療等)
- **件数**: 5 件/日
- **形式**: arXiv ID, URL, 著者, タイトル(日英併記), 要旨 3 行サマリ, 想定ビジネス読者層
