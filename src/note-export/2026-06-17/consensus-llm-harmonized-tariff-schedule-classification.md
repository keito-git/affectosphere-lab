...
#ビジネス #AI活用 #貿易 #コンプライアンス #輸出入

![consensus-llm-harmonized-tariff-schedule-classification](./consensus-llm-harmonized-tariff-schedule-classification.png)
...
「このコードを選んだのは○○規則の××条に該当するため」という形の根拠が出力されます。これが説明可能性を担保する部分です。
