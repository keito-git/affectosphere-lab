---
title: "希少疾患の診断に、AIは本当に使えるか——無作為化臨床試験で21ポイント向上を記録したLLM「RaDaR」の実力"
date: "2026-06-25"
excerpt: "320億パラメータのオープンソース推論LLM「RaDaR」を使った医師支援の無作為化臨床試験で、診断正答率が約21ポイント向上した。地方病院や専門医不在地域での希少疾患診断支援に向けた実装案を解説する。"
image: "/column-images/radar-rare-disease-diagnosis-llm-randomized-clinical-trial.png"
imageAlt: "医師とAIアシスタントが電子カルテを前に希少疾患の鑑別診断リストを確認するフラットイラスト"
readingMinutes: 5
