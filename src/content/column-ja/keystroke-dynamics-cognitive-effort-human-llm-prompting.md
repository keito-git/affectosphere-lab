---
title: "タイピングの「乱れ」が認知負荷を語る——キーストローク動態でLLMツールの「使いにくさ」を可視化する"
date: "2026-07-01"
excerpt: "36名の実験で、LLMへのプロンプト入力中のキーストローク動態が認知的負荷の受動的指標になることが確認された。社内LLMツールの利用ログを認知負荷センサとして活用するワークプレース分析の実装提案を解説する。"
image: "/column-images/keystroke-dynamics-cognitive-effort-human-llm-prompting.png"
imageAlt: "キーボード上の指の動きと認知負荷グラフが重なるフラットイラスト"
readingMinutes: 5
