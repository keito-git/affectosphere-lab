---
title: "国際契約のAIレビューはなぜ難しいのか ── 3管轄14,727条項が示す法務AIの限界と可能性"
date: "2026-06-14"
excerpt: "オーストラリア・英国・インド3管轄の商業契約書から14,727件の条項ペアを構築したデータセット「LAUKIN」が公開された。同じコモンロー系でも管轄間の起草慣行は大きく異なり、最良の評価モデルでもF1スコアは65.11%に留まる。グローバル法務AIが直面する本質的な困難を定量化した研究であり、法務・M&A・LegalTech担当者が今すぐ参照すべき内容だ。"
image: "/column-images/laukin-multijurisdictional-contract-dataset-legal-ai.png"
imageAlt: "オーストラリア・英国・インドの国旗と契約書書類が重なるビジュアル。各管轄の法的ドキュメントが中央のAI解析エンジンに集約される様子"
readingMinutes: 5
