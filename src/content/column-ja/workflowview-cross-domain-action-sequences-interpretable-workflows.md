---
title: "社員の「作業ログ」を意味ある業務フローに変換できるか？"
date: "2026-06-16"
excerpt: "ブラウザ操作履歴・学習プラットフォームのクリックログ・AIツール利用記録という3種類の低レベルデータを、LLMが高レベルの「ワークフロー」として解釈するフレームワークWorkflowViewを紹介。HR・DX・オペレーション部門がこれをどう試せるか、具体的なユースケースとともに考える。"
image: "/column-images/workflowview-cross-domain-action-sequences-interpretable-workflows.png"
imageAlt: "ブラウザログ・学習データ・AIツール利用履歴という異なる行動ログがLLMによって高レベルのワークフローとして抽象化されていく様子を表現した抽象的なイラスト"
readingMinutes: 5
