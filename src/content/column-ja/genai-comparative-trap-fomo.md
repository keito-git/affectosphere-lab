---
title: "AI の使いすぎは「個人の性格」ではなく「職場の競争設計」が原因かもしれない"
date: "2026-06-04"
excerpt: "社内 AI ランキングや活用状況の可視化が、過剰利用・依存・ワーカホリック的 AI 利用を誘発する。396名の調査が明かす「比較の罠」と、組織設計で対処する方法を読み解く。"
image: "/column-images/genai-comparative-trap-fomo.png"
imageAlt: "職場でAIツールの活用ランキングを見る社員たちが競争的な感情を抱く様子を抽象的に表現した図"
readingMinutes: 5
basedOnPaper: "The Comparative Trap: How Social Comparison Orientation Drives Problematic Generative AI Use"
basedOnPaperUrl: "https://arxiv.org/abs/2606.03560"
---
