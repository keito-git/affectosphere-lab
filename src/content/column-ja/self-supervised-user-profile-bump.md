---
title: "ラベルなしでユーザーを「読む」AIが、パーソナライゼーションを変える"
date: "2026-06-06"
excerpt: "タスクラベルも手動アノテーションも不要。行動ログから自然言語プロファイルを自動生成する自己教師ありフレームワーク BUMP が、LLMパーソナライゼーションの実装コストを根本から下げる可能性を持つ。"
image: "/column-images/self-supervised-user-profile-bump.png"
imageAlt: "ユーザーの行動履歴から自然言語プロファイルが自動生成され、AIがそれを参照して応答をパーソナライズするイメージ"
readingMinutes: 5
