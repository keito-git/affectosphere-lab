---
title: "社員の「次のキャリア」をAIが提案する時代——履歴書の時系列・学歴データから遷移確率を学ぶSTEPの現場応用"
date: "2026-07-14"
excerpt: "職歴・学歴・スキルを時系列で読み込み、「次に就くべき職種」を予測するSTEPというモデルが arXiv に公開されました。社内タレントマネジメントへの応用という観点から、HR部門・経営企画・リスキリング施策の担当者が「自社でどう試せるか」を考えます。"
image: "/column-images/step-career-path-recommendation-temporal-educational.png"
imageAlt: "時系列で並んだ職歴と学歴のカードが軌跡を描き、次のキャリアステップへと矢印でつながっていく図解のフラットイラスト"
readingMinutes: 5
