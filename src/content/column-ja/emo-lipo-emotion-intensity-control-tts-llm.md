---
title: "AIは「怒りの強さ」を表現できるか ── 感情強度制御TTSの新アプローチ"
date: "2026-06-14"
excerpt: "LLMベースの音声合成で「感情の強弱」を自在に制御するのは難しい課題だった。Emo-LiPOは感情強度をランキング問題として捉え、選好最適化で学習させることで既存手法を超える性能を達成した。「AIが感情の強さをどこまで表現できるか」に正面から向き合った研究だ。"
image: "/column-images/emo-lipo-emotion-intensity-control-tts-llm.png"
imageAlt: "感情強度の異なる音声波形が段階的に並ぶビジュアル。弱い感情から強い感情へとグラデーションで変化していく様子"
readingMinutes: 5
