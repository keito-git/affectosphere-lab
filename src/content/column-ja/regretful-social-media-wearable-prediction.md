---
title: "「またやってしまった」を予測する ── ウェアラブルとスマホログで後悔SNSを事前に検知する"
date: "2026-06-10"
excerpt: "スクロールしすぎたあとの後悔は、利用時間ではなく「意図とのギャップ」から生まれる。MIT・サンクトガレン大の研究チームが21名の野外実験で示した、ウェアラブル×文脈センシングによる後悔セッション予測の可能性を、ウェルネスアプリ開発者・HR担当向けに整理します。"
image: "/column-images/regretful-social-media-wearable-prediction.png"
imageAlt: "スマートウォッチとスマートフォンを持つ手、背景に感情の波形グラフが重なるフラットイラスト"
readingMinutes: 6
