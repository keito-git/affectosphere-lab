---
title: "現場の声はSNSに残る ── LLMで「事故が起きる前の意識変化」を検知する時代"
date: "2026-06-09"
excerpt: "建設作業員がSNSに書き残す言葉から、安全への意識を8次元で自動計測する研究が登場しました。kappa 0.90という高精度のLLM分類器が示すのは、社内アンケートでは見えなかった「現場の本音」を拾える可能性です。安全管理・HR・ESG担当が今すぐ使えるヒントとKPIに落とし込んで解説します。"
image: "/column-images/workforce-safety-attitude-llm-social-media.png"
imageAlt: "工事現場のシルエットとソーシャルメディアのテキストバブル、その上にAI分析のダッシュボードが重なるフラットイラスト"
readingMinutes: 5
