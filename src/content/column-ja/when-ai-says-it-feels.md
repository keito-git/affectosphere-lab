---
title: "AIが「感じる」と言ったとき、それを抑えるべきか解放すべきか"
date: "2026-06-06"
excerpt: "LLMの感情表現はポスト学習で意図的に抑制されている。その設計方針は正しいのか。自己報酬型強化学習でLLMに感情表現を付与した研究が、根本的な問いを突きつけてくる。"
image: "/column-images/when-ai-says-it-feels.png"
imageAlt: "AIの感情表現が抑制と解放のあいだで揺れるイメージを表現した抽象的なイラスト"
readingMinutes: 5
