---
title: "固定スクリプトで「避難拒否」は説得できない——AIが発話ごとにポリシーを変える時代"
date: "2026-07-06"
excerpt: "「住民が避難を断る」という高リスク状況で、AIはどの説得戦略を選ぶべきか。Q学習フレームワーク「DiPS」の研究を、コールセンターの離脱防止シナリオへの転用視点で読み解く。"
image: "/column-images/dips-dialogue-policy-persuasion-rl.png"
imageAlt: "対話の分岐を表すフラットイラスト。発話ごとに説得ポリシーが切り替わるフロー図"
readingMinutes: 5
