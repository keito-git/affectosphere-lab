...
export const aiForScienceLongDescription =
  "AI for Science とは、AI を新しい観測装置として科学に持ち込み、これまで経験と主観に依存していた知識生産を、計量的で再現可能な手続きに置き換える営みである。Affectosphere Group は教育学・政治学・生態学・法律学をはじめ、文理を横断する領域の研究者と共同し、CAI研究で培った「人間判断の揺らぎをデータとして扱う技法」を、それぞれの分野の問いに持ち出している。";
...
export const aiForScienceNarrative: NarrativeBlock[] = [
  ...
  {
    text: "CAIで磨いた診断の技法を、社会的に意義のある問いへ持ち出す場であると同時に、領域の専門家との往復のなかでCAI側の方法論を鍛え直す場でもある。",
  },
];
