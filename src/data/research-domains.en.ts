...
export type NarrativeBlock = {
  /** Short heading, so a long domain can be skimmed. */
  heading?: string;
...
export const researchDomains: ResearchDomain[] = [
  // ===================================================================
  {
    ...
    narrative: [
      ...
      {
        heading: "What falls between the layers",
        text:
      ...
      {
        heading: "Diagnosing four fractures",
        text:
  ...
  // ===================================================================
  {
    ...
    narrative: [
      ...
      {
        heading: "The flattening into labels",
        text:
      ...
      {
        heading: "Disagreement is not noise",
        text:
      ...
      {
        heading: "Transitions out of disagreement",
        text:
      ...
      {
        heading: "Persistence and contagion",
        text:
      ...
      {
        heading: "Checked against theory",
        text:
  ...
  // ===================================================================
  {
    ...
    narrative: [
      ...
      {
        heading: "Letting knowledge set the direction",
        text:
      ...
      {
        heading: "Building a persona in stages",
        text:
  ...
  // ===================================================================
  {
    ...
    narrative: [
      ...
      {
        heading: "The label, not the spread",
        text:
      ...
      {
        heading: "Lexical emotion, inferred emotion",
        text:
      ...
      {
        heading: "Splitting the uncertainty",
        text:
      ...
      {
        heading: "Bayesian sampling as the means",
        text:
  ...
  // ===================================================================
  {
    ...
    narrative: [
      ...
      {
        heading: "Reading sarcasm with a world model",
        text:
      ...
      {
        heading: "Building in the causal chain",
        text:
      ...
      {
        heading: "Circulating notes, talking it over",
        text:
      ...
      {
        heading: "Two branches, evidential uncertainty",
        text:
      ...
      {
        heading: "Made light enough for the vehicle",
        text:
  ...
  // ===================================================================
  {
    ...
    narrative: [
      ...
      {
        heading: "When affect becomes a product",
        text:
      ...
      {
        heading: "Turning intensity down, keeping meaning",
        text:
      ...
      {
        heading: "Reading latent preference",
        text:
  ...
  // ===================================================================
  {
    ...
    narrative: [
      ...
      {
        heading: "A framework for family communication",
        text:
      ...
      {
        heading: "Five roles, played apart",
        text:
      ...
      {
        heading: "Judged by people, run by machine",
        text:
  ...
  // ===================================================================
  {
    ...
    narrative: [
      ...
      {
        heading: "Asking who it reminds you of",
        text:
      ...
      {
        heading: "Recall beats reasoning",
        text:
      ...
      {
        heading: "A systematic comparison",
        text:
